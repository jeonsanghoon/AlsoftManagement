...
namespace loggalWebMng.Controllers
{
    ...
    public class BaseController : MVCBaseController
    {
        ...
        protected override void Initialize(System.Web.Routing.RequestContext requestContext)
        {
            ...
            logger.Debug("Initialize 1=>" + Request.Url.OriginalString);
                ...
                )
            {
                ...
                {
                    logger.Debug("Initialize 2=>" + Request.Url.OriginalString);
                    string host = string.Empty;
                    //GlobalMvc.Common.HttpCheckRedirect("/home/login");
                    
                    this.RouteData.Values["controller"] = "home";
                    this.RouteData.Values["action"] = "login";
                    return;
                }
            }
            logger.Debug("Initialize 3=>" + Request.Url.OriginalString);
