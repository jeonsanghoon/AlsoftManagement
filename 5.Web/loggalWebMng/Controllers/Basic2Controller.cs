...
namespace loggalWebMng.Controllers
{
    public partial class BasicController : BaseController
    {
        ...
        #region >> 배너공유요청현황
        [AltloggalAuthorization]
        public ActionResult deviceAdShareRequest()
        {
            return View();
        }
        [AltloggalAuthorization]
        public PartialViewResult pv_deviceAdShareRequest(DEVICE_MAIN_SHARE_COND Cond)
        {
        ...
        #region >> 로컬박스공유승인현황
        [AltloggalAuthorization]
        public ActionResult deviceAdShareReceive()
        {
            return View();
        }
        #endregion 
